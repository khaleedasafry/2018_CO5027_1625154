<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebApplication1.Member.index" %>
...
<p>This page is in a different folder - eventually it should be secured by a login system, but for now it is important to make sure that it's links work once it is has been migrated to ASP.NET.</p>
<p>
